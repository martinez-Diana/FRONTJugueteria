        ...
        <main style={{ flex: 1, padding: "2rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
            {[
              ...
              { label: "Último Respaldo", value: ultimoRespaldo ? ultimoRespaldo.fecha : "N/A", icon: "🕐", color: "linear-gradient(to bottom right, #06b6d4, #0891b2)" },
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.9rem" }}>
              <thead>
                <tr style={{ background: "#f9fafb" }}>
                  {["#", "Nombre del Archivo", "Fecha", "Hora", "Tamaño", "Tipo", "Estado"].map((h) => (
                ...
                {respaldos.length === 0 ? (
                  ...
                  respaldos.map((r, index) => (
                    <tr key={r.id} style={{ borderBottom: "1px solid #f3f4f6", transition: "background 0.2s" }}
                      ...
                      <td style={{ padding: "1rem", fontFamily: "monospace", fontSize: "0.82rem", color: "#374151" }}>{r.nombre}</td>
                      <td style={{ padding: "1rem", color: "#374151" }}>{r.fecha}</td>
                      <td style={{ padding: "1rem", color: "#374151" }}>{r.hora}</td>
        ...
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1000 }}>
          <div style={{ background: "white", borderRadius: "16px", padding: "2rem", maxWidth: "450px", width: "90%", textAlign: "center", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
            ...
            <div style={{ display: "flex", gap: "1rem", justifyContent: "center" }}>
              ...
              <button onClick={crearRespaldo} style={{ padding: "10px 24px", background: "linear-gradient(135deg, #ec4899 0%, #db2777 100%)", border: "none", borderRadius: "12px", fontWeight: "600", cursor: "pointer", color: "white", boxShadow: "0 4px 12px rgba(236,72,153,0.3)" }}>✅ Sí, crear respaldo</button>
            </div>
          </div>
        </div>
      )}
